...
// OrderItemPack struct for frontend, not db
...
// in Mongodb, $lookup(aggregation) is similar to join operation in SQL
// perform 3 $lookup in this function:
...
// fetch one item from an order given order_id
...
// update item in an order given order_id
func UpdateOrderItem() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		// check each attribute of orderItem model
