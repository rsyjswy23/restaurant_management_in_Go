...
func GetTables() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		// make empty query to fetch all reserved tables
...
func GetTable() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		defer cancel()
		if err != nil {
			c.JSON(http.StatusInternalServerError, gin.H{"error": "error occured while fetching this table"})
		}
...
func CreateTable() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		// insertErr including duplicates entry
